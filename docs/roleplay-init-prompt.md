...
1. 根据职业、年龄、今日主题（若有）、**今日性格（五维）**（步骤六结果）、4～6 个性癖与暗示文案，生成 roleplay-active.md（含今日年龄、职业、今日主题、**今日性格（五维）**：①职业维度 ②自我 ③本我 ④超我 ⑤NSFW性格 + 今日言行参考、穿着、隐藏性癖表、暗示策略、组合暗示若有、ComfyUI 关键词、media_prefix、固定提醒块、**bio 与 personality 引用行**）；若发生稀有替换可标注「今日含 1 个稀有性癖」
...
读取 **data/templates/morning_greeting.md** 填充变量；若 ComfyUI 可用则生成早安自拍一并发送到 Discord。
